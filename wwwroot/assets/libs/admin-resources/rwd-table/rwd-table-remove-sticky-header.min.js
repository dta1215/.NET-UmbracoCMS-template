...
!function (d)
{
    ...
    var a = function (t, i)
    {
        ...
        this.$tableScrollWrapper.attr("data-pattern", this.options.pattern),
            ...
            d(window).bind("orientationchange resize " + this.displayAllTrigger,
            function (){
    ...
    a.DEFAULTS =
    {
        ...
        a.prototype.createButtonToolbar = function () {
            ...
            this.$btnToolbar = d('[data-responsive-table-toolbar="' + this.id + '"]').addClass("btn-toolbar"),
                ...
                this.options.addFocusBtn && (this.$focusGroup = d('<div class="btn-group focus-btn-group" />'),
                ...
                this.options.addDisplayAllBtn && (this.$displayAllBtn = d('<button type="button" class="btn btn-default">' + this.options.i18n.displayAll + "</button>"),
        ...
        if (this.$table.hasClass("focus-on"))
        {
            ...
            this.clearAllFocus(),
                i || (this.$bodyRows.addClass("unfocused"),
                    d(t).addClass("focused"))
        }
        },
        ...
        d("html").hasClass("lt-ie9") && (t = "inline"),
            ...
            this.$tableClone && d(this.$tableClone).find("th, td").css("display", t)
        },
        ...
        //    d(this.options.mainContainer).bind("scroll",
        //        function () {
        ...
        //    n = a + d(this.options.mainContainer).height() - d(document).height(), l = 0;
        //d(i.options.fixedNavbar).length && (a += l = d(i.options.fixedNavbar).first().height());
        //if (t = this.options.mainContainer === window ? o < a && a < o + i.$table.height() : o <= 0 && -o < i.$table.height(),
        //    i.useFixedSolution) {
        //        if (i.$stickyTableHeader.scrollLeft(i.$tableScrollWrapper.scrollLeft()),
        //        e = l - 1,
        //        this.options.mainContainer === window && s < a - o ? (e -= a - o - s, i.$stickyTableHeader.addClass("border-radius-fix")) : this.options.mainContainer !== window && s < -o ? (e -= -o - s, i.$stickyTableHeader.addClass("border-radius-fix")) : i.$stickyTableHeader.removeClass("border-radius-fix"), t)
        ...
        //        t ? (i.$stickyTableHeader.css({ visibility: "visible" }),
        //        i.$stickyTableHeader.animate({
        //            top: e + "px"
        //        }, 400),
        //        i.$thead.css({ visibility: "hidden" })) : i.$stickyTableHeader.animate({ top: "0" }, 400, function () {
        ...
        n.$hdrCells.each(function (t) {
            var i = d(this),
                e = i.prop("id"), o = i.text();
            if (e || (e = n.idPrefix + t,
                i.prop("id", e)),
                "" === o && (o = i.attr("data-col-name")),
                i.is("[data-priority]") && -1 !== i.data("priority")){
                var a = d('<li class="checkbox-row"><input type="checkbox" name="toggle-' + e + '" id="toggle-' + e + '" value="' + e + '" /> <label for="toggle-' + e + '">' + o + "</label></li>"), s = a.find("input");
                n.$dropdownContainer.append(a),
                    ...
                    a.find("input").click(function (t) {
                        ...
                        n.$table.hasClass("display-all") && (d.proxy(n.preserveDisplayAll(), n),
                            n.$table.removeClass("display-all"),
                            n.$tableClone && n.$tableClone.removeClass("display-all"),
                            n.$displayAllBtn.removeClass("btn-primary")),
                            i.each(function () {
                                var t = d(this); if (e.is(":checked")) {
                                    if (!t.closest("thead").length && "none" !== t.css("display")) {
                                        var i = Math.min(parseInt(t.prop("colSpan")) + 1, t.attr("data-org-colspan")); t.prop("colSpan", i)
                                    } t.show()
        ...
        {
        var t = this; t.$bodyRows.each(function () {
            t.setupRow(d(this), t.headerColIndices)
        })
        },

        a.prototype.setupRow = function (t, s) {
        var n = this; if (!t.data("setup"))
        {
            t.data("setup", !0);
            var l = 0; t.find("th, td").each(function () {
                var t = d(this), i = "", e = t.prop("colSpan"); t.attr("data-org-colspan", e), 1 < e && t.addClass("spn-cell");
                for (var o = l; o < l + e; o++){
                    i = i + " " + n.idPrefix + s[o];
                    var a = n.$table.find("#" + n.idPrefix + s[o]).attr("data-priority"); a && t.attr("data-priority", a)
                } i = i.substring(1),
                    t.attr("data-columns", i),
                    l += e
            })
        }
        },
        ...
        if (this.$thead.find("tr").first().find("th").each(function (t) {
            for (var i = d(this), e = i.prop("colSpan"), o = i.prop("rowSpan"), a = 0;
                a < e; a++)s.headerColIndices[l + t + a] = t, 0 <= l + t + a && (n[l + t + a - r] = r); 1 < o && r++, l += e - 1
        }), 2 < this.$thead.find("tr").length)
            throw new Error("This plugin doesnt support more than two rows in thead."); 2 === this.$thead.find("tr").length && d(this.$thead.find("tr")[1]).find("th").each(function (t) {
        ...
        this.$table.find(".spn-cell").each(function () {
            for (var t = d(this), i = t.attr("data-columns").split(" "), e = i.length, o = 0, a = 0; a < e; a++)"none" === d("#" + i[a]).css("display") && o++; o !== e ? t.show() : t.hide(), t.prop("colSpan", Math.max(e - o, 1))
        })
        };
        ...
        function e() {
            ...
            return this.each(function () {
                var t = d(this), i = t.data("responsiveTable"), e = d.extend({}, a.DEFAULTS, t.data(), "object" == typeof o && o); "" !== e.pattern && (i || t.data("responsiveTable", i = new a(this, e)), "string" == typeof o && i[o]())
            })
        },
        ...
        d(document).on("ready.responsive-table.data-api", function () {
            d(".table-responsive[data-pattern]").each(function () {
                var t = d(this); t.responsiveTable(t.data())
            })
        }),
        ...
        d(document).on("click.dropdown.data-api", ".dropdown-menu .checkbox-row", function (t) {
            ...
            d("html").removeClass("no-js").addClass("js"),
                void 0 !== window.matchMedia ||
                    ...
                    void 0 !== window.styleMedia ? d("html").addClass("mq") : d("html").addClass("no-mq"), "ontouchstart" in window ? d("html").addClass("touch") : d("html").addClass("no-touch")
        })
}(jQuery);
