    ...
    "use strict"; function n(t) {
        ...
        return (l = Object.assign || function (t) {
            for (var e = 1; e < arguments.length; e++){
                var i = arguments[e]; for (var r in i) Object.prototype.hasOwnProperty.call(i, r) && (t[r] = i[r])
            } return t
        ...
        return function (t) {
            ...
            var i = [], r = !0, n = !1, s = void 0; try {
                for (var a, o = t[Symbol.iterator]();
                    !(r = (a = o.next()).done) && (i.push(a.value), !e || i.length !== e); r = !0);
            }
            catch (t) {
                n = !0, s = t
            }
        ...
        d = {
            ...
            warnOnce: function (t) { e[t] || (e[t] = !0, this.warn.apply(this, arguments)) }, _resetWarnings: function () {
                e = {}
                ...
                date: function (t) {
                    ...
                    }), 4), r = (i[0], i[1]), n = i[2], s = i[3], a = new Date(r, n - 1, s); return a.getFullYear() !== r || a.getMonth() + 1 !== n || a.getDate() !== s ? null : a
                },
                string: function (t) {
                    return t
                },
            ...
            namespaceEvents: function (t, e) {
                ...
                var r = []; return h.each(t, function (t, e) { -1 == i.indexOf(e) && r.push(e) }), r
            },
            all: function (t) {
            ...
            objectCreate: Object.create || function (t) {
                ...
                if ("object" != n(t)) throw TypeError("Argument must be an object"); i.prototype = t;
                var e = new i;
        ...
        priorityEnabled: !0, multiple: null,
        group: null,
        uiEnabled: !0,
    ...
    r.prototype = {
        ...
        _resetOptions: function (t) {
            for (var e in this.domOptions = d.objectCreate(this.parent.options),
                this.options = d.objectCreate(this.domOptions), t) t.hasOwnProperty(e) && (this.options[e] = t[e]);
        ...
        off: function (t, e) {
            ...
            if (i) if (e) for (var r = i.length; r--;)i[r] === e && i.splice(r, 1);
        ...
        asyncIsValid: function (t, e) {
            return d.warnOnce("asyncIsValid is deprecated; please use whenValid instead"),
        ...
        x.addMessages("vn", {
            ...
            type: {
                email: "Giá trị phải là một email hợp lệ",
                url: "Giá trị phải là một Url hợp lệ",
                number: "Giá trị phải là một số hợp lệ",
                integer: "Giá trị phải là một số nguyên hợp lệ",
                digits: "Giá trị phải là một dãy chữ số hợp lệ",
                alphanum: "Giá trị phải là một chữ hợp lệ"
            },
            notblank: "Giá trị không được để trống",
            required: "Phải nhập dữ liệu, không được để trống",
            pattern: "Giá trị không hợp lệ",
            min: "Dữ liệu nhập vào phải lớn hơn hoặc bằng %s",
            max: "Dữ liệu nhập vào phải nhỏ hơn hoặc bằng %s",
            range: "Giá trị phải nằm trong khoảng %s và %s ký tự",
            minlength: "Giá trị có độ dài quá ngắn. Độ dài phải lớn hơn hoặc bằng %s ký tự",
            maxlength: "Giá trị có độ dài quá dài. Độ dài phải nhỏ hơn hoặc bằng %s ký tự",
            length: "Độ dài của giá trị không hợp lệ. Độ dài giá trị phải nằm trong khoảng %s và %s ký tự",
            mincheck: "Bạn phải chọn ít nhất %s lựa chọn",
            maxcheck: "Bạn chỉ được chọn nhiều nhất %s lựa chọn",
            check: "Bạn phải chọn từ %s đến %s lựa chọn",
            equalto: "Giá trị nhập phải bằng nhau"
            }),
            x.setLocale("vn"), (new function () {
        var r = this, n = window || global; l(this, {
            ...
            install: function () {
                if (!n.inputEventPatched) {
                    ...
                    for (var t = 0, e = ["select", 'input[type="checkbox"]', 'input[type="radio"]', 'input[type="file"]'];
                        t < e.length; t++){
                            var i = e[t]; h(document).on("input.inputevent", i,
                                { selector: i }, r.behavesOk).on("change.inputevent", i, { selector: i }, r.misbehaves)
                    }
                }
            },
            uninstall: function () {
