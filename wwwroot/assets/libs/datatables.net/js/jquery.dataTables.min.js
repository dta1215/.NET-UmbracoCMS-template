...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Đầu",sLast:"Cuối",sNext:"Tiếp",sPrevious:"Trước"},sEmptyTable:"Không có dữ liệu",sInfo:"Hiển thị _START_ đến _END_ của _TOTAL_ bản ghi",sInfoEmpty:"Hiển thị 0 đến 0 của 0 bản ghi",sInfoFiltered:"(được lọc từ _MAX_ bản ghi)",
    sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Hiển thị _MENU_ bản ghi", sLoadingRecords: "Loading...", sProcessing: "Đang thực hiện...", sSearch: "Search:", sSearchPlaceholder: "", sUrl: "", sZeroRecords:"Không tìm thấy kết quả"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(l.defaults);l.defaults.column={aDataSort:null,
